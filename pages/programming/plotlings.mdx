...
<Image src="/images/programming/plotlings/line_groups.svg" alt="Groups of wavy lines overlaid on top of each other at regular intervals" width="523" height="900" />
...
<Image src="/images/programming/plotlings/maze.svg" alt="An unsolvable maze" width="900" height="655" />
...
<Image src="/images/programming/plotlings/dune.svg" alt="A series of regularly spaced triangles that, together, have the appearance of a sand dune" width="673" height="900" subtitle="A naïve recreation of Sohan Murthy's Continuity Correction that ended up going in a new direction."/>
...
<Image src="/images/programming/plotlings/line_noise.svg" alt="A cloud of short horizontal lines" width="816" height="1056" />
