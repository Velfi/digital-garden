import LineGroups from "@/public/images/programming/plotlings/line_groups.svg";
import Maze from "@/public/images/programming/plotlings/maze.svg";
import Dune from "@/public/images/programming/plotlings/dune.svg";
import LineNoise from "@/public/images/programming/plotlings/line_noise.svg";
...
<Image src={LineGroups} alt="Groups of wavy lines overlaid on top of each other at regular intervals" />
...
<Image src={Maze} alt="An unsolvable maze" width="900" height="655" />
...
<Image src={Dune} alt="A series of regularly spaced triangles that, together, have the appearance of a sand dune" subtitle="A naïve recreation of Sohan Murthy's Continuity Correction that ended up going in a new direction."/>

I had a link to [Sohan's page][Sohan Murthy's Continuity Correction] here, but it broke and I can't find the original artwork anymore.

### Line Noise

Run it with this command: `cargo run release --bin line_noise`

<Image src={LineNoise} alt="A cloud of short horizontal lines" />
