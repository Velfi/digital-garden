...
<Image src="/images/programming/plotlings/line_groups.svg" alt="Groups of wavy lines overlaid on top of each other at regular intervals" />
...
<Image src="/images/programming/plotlings/dune.svg" alt="A series of regularly spaced triangles that, together, have the appearance of a sand dune" subtitle="A naïve recreation of Sohan Murthy's Continuity Correction that ended up going in a new direction."/>
...
<Image src="/images/programming/plotlings/line_noise.svg" alt="A cloud of short horizontal lines" />
