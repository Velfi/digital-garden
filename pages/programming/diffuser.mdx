...
<Image src="/images/programming/diffuser/diffuser-example-1.png" alt="Diffuser example 1" width="799" height="346" layout="responsive" subtitle="Writing my own name" />
