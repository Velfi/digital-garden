import DiffuserExample1 from "@/public/images/programming/diffuser/diffuser-example-1.png";
...
<Image
  src={DiffuserExample1}
  alt="Diffuser example 1"
  subtitle="Writing my own name"
/>
