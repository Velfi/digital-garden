              ...
              <div class="piscina-fin-row">
                <label class="tool-panel-check"
                  ><input
                    ...
                    onchange={(e) =>
                      piscinaShowFinDorsal.set((e.target as HTMLInputElement).checked)}
                  />On</label
                >
                <input
                  type="range"
              ...
              <div class="piscina-fin-row">
                <label class="tool-panel-check"
                  ><input
                    ...
                    onchange={(e) =>
                      piscinaShowFinCaudal.set((e.target as HTMLInputElement).checked)}
                  />On</label
                >
                <input
                  type="range"
              ...
              <div class="piscina-fin-row">
                <label class="tool-panel-check"
                  ><input
                    ...
                    onchange={(e) =>
                      piscinaShowFinPelvic.set((e.target as HTMLInputElement).checked)}
                  />On</label
                >
                <input
                  type="range"
                  ...
                  oninput={(e) =>
                    piscinaFinPelvic.set(Number((e.target as HTMLInputElement).value))}
            ...
            <div class="piscina-fin-group">
              ...
              <div class="piscina-fin-row">
                ...
                <input
                  ...
                  oninput={(e) =>
                    piscinaFinAdipose.set(Number((e.target as HTMLInputElement).value))}
