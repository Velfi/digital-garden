...
export const GENERATOR_TOOLS = ['rocks', 'grass', 'ashlar', 'roof', 'flora', 'piscina'] as const;
...
export const GENERATOR_FACE_CLICK_TOOLS = ['rocks', 'grass', 'ashlar', 'flora', 'piscina'] as const;
